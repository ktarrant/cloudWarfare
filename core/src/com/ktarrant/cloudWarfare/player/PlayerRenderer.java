...
//    }
//
//    public void drawEnvironmentData(PlayerComponent playerComponent) {
//        float playerRadius = playerComponent.circleShape.getRadius();
...
//    }
//
//    public void drawPlayerState(PlayerComponent playerComponent) {
//        textBatch.begin();
//        Vector2 playerPos = playerComponent.body.getPosition();
//        font.draw(textBatch, String.valueOf(playerComponent.state.stateIcon), playerPos.x, playerPos.y);
//        textBatch.end();
//    }
//
